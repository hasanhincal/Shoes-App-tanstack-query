...
const Filter = ({ isOpen, close }: Props) => {
  ...
  return (
    <div
      className={
        isOpen
          ? `max-lg:fixed z-10 max-lg:inset-0 max-lg:grid max-lg:place-items-center max-lg:bg-zinc-900 max-lg:bg-opacity-60`
          : "max-lg:hidden"
      }
    >
      <div className="max-lg:max-w-lg max-lg:mx-auto max-lg:h-[85vh] ">
